...
export class ProductGetService extends BaseHttpService{
  ...
  public getItemsPage(pagination: IPaginationArgs): Observable<IProductItemsPageDto> {
    let {page, pageSize} = pagination;
    return this.http.get<IProductItemsPageDto>(`${env.apiUrl}/ProductItemsPage`, {params: {page, pageSize}})
      .pipe(
